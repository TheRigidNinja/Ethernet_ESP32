...
[PG]   - [GPIO 34][29] --> Motor Speed Signal Output
[SV]   - [GPIO 32][27] --> Analogy signal input terminal (AKA PWM input) 
[EN]   - [GPIO 23][23] --> Motor run/stop control
[F/R]  - [GPIO 21][21] --> Motor forward/reverse control

GPIOs: 2, 4, 5, 12, 13, 14, 15, 16, 17, 18, 32, 33
GPIOs: 34, 35, 36, 39
...
Ethernet pins (RMII: GPIOs 0, 19, 21, 22, 25-27)
JTAG pins (GPIOs 12-14) if debugging